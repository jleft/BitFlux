...
return g=a.time.day.offset(g,7*l),h-=l*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f}function ja(){function c(){return{week1:Aa.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:Aa.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:Aa.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:Aa.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:Aa.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function d(){return{generated:Aa.data.source(ca(),null,null,null,ia()),bitcoin:Aa.data.source(da(),ea,fa(),S,b.scale.discontinuity.identity()),quandl:Aa.data.source(ga(),ha,null,null,ia())}}function e(){return{
// generated: model.data.product('Data Generator', 'Data Generator', [periods.day1], sources.generated, '.3s'),
quandl:Aa.data.product("GOOG","GOOG",[j.day1],k.quandl,".3s"),quandl2:Aa.data.product("AAPL","AAPL",[j.day1],k.quandl,".3s"),quandl3:Aa.data.product("LNKD","LNKD",[j.day1],k.quandl,".3s"),quandl4:Aa.data.product("MSFT","MSFT",[j.day1],k.quandl,".3s")}}function f(){var a=v();a.id=qa.uid();var c=Aa.menu.option("Candlestick","candlestick",a,"bf-icon-candlestick-series");c.isSelected=!0,c.option.extentAccessor=["high","low"];var d=b.series.ohlc();d.id=qa.uid();var e=Aa.menu.option("OHLC","ohlc",d,"bf-icon-ohlc-series");e.option.extentAccessor=["high","low"];var f=b.series.line().xValue(function(a){return a.date});f.id=qa.uid();var g=Aa.menu.option("Line","line",f,"bf-icon-line-series");g.option.extentAccessor="close";var h=b.series.point().xValue(function(a){return a.date});h.id=qa.uid();var i=Aa.menu.option("Point","point",h,"bf-icon-point-series");i.option.extentAccessor="close";var j=b.series.area().xValue(function(a){return a.date});j.id=qa.uid();var k=Aa.menu.option("Area","area",j,"bf-icon-area-series");k.option.extentAccessor="close";var l=Aa.menu.dropdownConfig(null,!1,!0,!0),m=[c,e,g,i,k];return Aa.menu.selector(l,m)}function g(){var a=ta.secondary,c=b.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).xValue(function(a){return a.date}).yValue(function(a){return a.movingAverage});c.id=qa.uid();var d=Aa.menu.option("Moving Average","movingAverage",c,"bf-icon-moving-average-indicator",!0);d.option.extentAccessor=function(a){return a.movingAverage};var e=b.indicator.renderer.bollingerBands();e.id=qa.uid();var f=Aa.menu.option("Bollinger Bands","bollinger",e,"bf-icon-bollinger-bands-indicator",!0);f.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var g=[d,f,Aa.menu.option("Relative Strength Index","rsi",a.rsi(),"bf-icon-rsi-indicator",!1),Aa.menu.option("MACD","macd",a.macd(),"bf-icon-macd-indicator",!1),Aa.menu.option("Volume","volume",a.volume(),"bf-icon-bar-series",!1)];return g}function h(){var a=Aa.menu.dropdownConfig("Add Indicator",!1,!0);return Aa.menu.selector(a,g())}function i(){return{seriesSelector:f(),indicatorSelector:h()}}var j=c(),k=d(),l=e();return{periods:j,sources:k,primaryChart:Aa.chart.primary(l.quandl,l.quandl.source.discontinuityProvider),secondaryChart:Aa.chart.secondary(l.quandl,l.quandl.source.discontinuityProvider),selectors:i(),xAxis:Aa.chart.xAxis(j.day1,l.quandl.source.discontinuityProvider),nav:Aa.chart.nav(l.quandl.source.discontinuityProvider),navReset:Aa.chart.navigationReset(),headMenu:Aa.menu.head([l.quandl,l.quandl2,l.quandl3,l.quandl4],l.quandl,j.day1),legend:Aa.chart.legend(l.quandl,j.day1),overlay:Aa.menu.overlay([l.quandl,l.quandl2,l.quandl3,l.quandl4],l.quandl),notificationMessages:Aa.notification.messages()}}function ka(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function la(a,b,c,d){return a.map(function(a){return Aa.data.product(a.id,a.id,d.get(a.id)||c,b)})}function ma(){function c(){Y&&(Y=!1),$&&H.suspendLayout(!1),H.primary.datum(T.primaryChart).call(V.primary),H.legend.datum(T.legend).call(V.legend),H.secondaries.datum(T.secondaryChart).filter(function(a,b){return b<V.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container secondary-"+V.secondaries[c].valueString).call(V.secondaries[c].option)}),H.xAxis.datum(T.xAxis).call(V.xAxis),H.navbar.datum(T.nav).call(V.navbar),H.app.select("#navbar-reset").datum(T.navReset).call(M),H.app.select(".head-menu").datum(T.headMenu).call(K),H.app.selectAll(".selectors").datum(T.selectors).call(O),H.app.select("#notifications").datum(T.notificationMessages).call(P),H.overlay.datum(T.overlay).call(J),$&&(H.suspendLayout(!0),$=!1)}function d(){$=!0,qa.layout(H,V)}function e(){a.select(window).on("resize",function(){d(),Z()})}function f(a){T.notificationMessages.messages.unshift(N(a))}function g(a){var b=[a[0],a[1]];T.primaryChart.viewDomain=b,T.secondaryChart.viewDomain=b,T.xAxis.viewDomain=b,T.nav.viewDomain=b;var c=qa.domain.trackingLatestData(T.primaryChart.viewDomain,T.primaryChart.data);T.primaryChart.trackingLatest=c,T.secondaryChart.trackingLatest=c,T.nav.trackingLatest=c,T.navReset.trackingLatest=c,Z()}function h(a){a.isSelected=!a.isSelected,A(),Z()}function i(a){a.isSelected=!a.isSelected,C(),Z()}function j(a){T.legend.data=a,Z()}function k(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):S(a),c&&(f(c),Z())}function l(){var a=T.primaryChart.data,c=b.util.extent().fields("date")(a),d=qa.domain.moveToLatest(T.primaryChart.discontinuityProvider,c,a,X);g(d)}function m(a,b){var c='<div class="spinner"></div>',d=arguments.length>1||a,e="";b&&b.length&&(e='<div class="content alert alert-info">'+b+"</div>"),H.app.select("#loading-status-message").classed("hidden",!d).html(b?e:c)}function n(a){T.primaryChart.data=a,T.secondaryChart.data=a,T.nav.data=a}function o(a){var b=a.discontinuityProvider;T.xAxis.discontinuityProvider=b,T.nav.discontinuityProvider=b,T.primaryChart.discontinuityProvider=b,T.secondaryChart.discontinuityProvider=b}function p(a){T.headMenu.selectedProduct=a,T.primaryChart.product=a,T.secondaryChart.product=a,T.legend.product=a,T.overlay.selectedProduct=a,o(a.source)}function q(a){T.headMenu.selectedPeriod=a,T.xAxis.period=a,T.legend.period=a}function r(a){m(!0),p(a),q(a.periods[0]),U(a.periods[0].seconds,a)}function s(){return ta.primary().on(ra.crosshairChange,j).on(ra.viewChange,g)}function t(){return ta.nav().on(ra.viewChange,g)}function u(){return ua.navigationReset().on(ra.resetToLatest,l)}function v(){return L().on(ra.newTrade,function(a,b){if(n(a),T.primaryChart.trackingLatest){var c=qa.domain.moveToLatest(T.primaryChart.discontinuityProvider,T.primaryChart.viewDomain,T.primaryChart.data);g(c)}}).on(ra.historicDataLoaded,function(a,b){m(!1),n(a),T.legend.data=null,l(),d()}).on(ra.historicFeedError,function(a,b){if(I){var c=I(a)||!0;m(!1,c)}else{m(!1,"Error loading data. Please make your selection again, or refresh the page.");var d="";try{var e=JSON.parse(a.responseText),g=b.historicNotificationFormatter(e);g&&(d=". "+g)}catch(h){d=""}var i=a.statusText||"Unknown reason.",j="Error getting historic data: "+i+d;f(j)}Z()}).on(ra.streamingFeedError,k).on(ra.streamingFeedClose,k)}function w(){return ua.head().on(ra.dataProductChange,function(a){r(a.option),Z()}).on(ra.dataPeriodChange,function(a){m(!0),q(a.option),U(a.option.seconds),Z()}).on(ra.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){T.primaryChart.indicators.forEach(y),V.secondaries.forEach(y),A(),C(),Z()})}function x(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function y(a){a.isSelected=!1}function z(){return ua.selectors().on(ra.primaryChartSeriesChange,function(a){T.primaryChart.series=a,x(a,T.selectors.seriesSelector.options),Z()}).on(ra.primaryChartIndicatorChange,h).on(ra.secondaryChartChange,i)}function A(){T.primaryChart.indicators=T.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),T.overlay.primaryIndicators=T.primaryChart.indicators}function B(){V.secondaries=T.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),
// TODO: This doesn't seem to be a concern of menu.
V.secondaries.forEach(function(a){a.option.on(ra.viewChange,g)}),T.overlay.secondaryIndicators=V.secondaries}function C(){B(),
// TODO: Remove .remove! (could a secondary chart group component manage this?).
H.secondaries.selectAll("*").remove(),d()}function D(){return ua.overlay().on(ra.primaryChartIndicatorChange,h).on(ra.secondaryChartChange,i).on(ra.dataProductChange,function(a){r(a.option),Z()})}function E(a){T.notificationMessages.messages=T.notificationMessages.messages.filter(function(b){return b.id!==a}),Z()}function F(){return va.toast().on(ra.notificationClose,E)}function G(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;T.notificationMessages.messages.unshift(N(e))}else{var f=[T.periods.hour1,T.periods.day1],g=a.map();g.set("BTC-USD",[T.periods.minute1,T.periods.minute5,T.periods.hour1,T.periods.day1]);var h=la(c,T.sources.bitcoin,f,g);T.headMenu.products=T.overlay.products=T.headMenu.products.concat(h)}Z()}var H,I,J,K,M,O,P,Q='<div class="container-fluid">         <div id="notifications"></div>         <div id="loading-status-message"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div class="selectors">                     <div class="series-dropdown dropdown selector-dropdown"></div>                     <div class="indicator-dropdown dropdown selector-dropdown"></div>                     <div id="mobile-period-selector" class="dropdown"></div>                 </div>                 <div id="period-selector"></div>                 <span id="clear-indicators" class="icon bf-icon-delete delete-button"></span>             </div>         </div>         <div class="row primary-row">             <div id="charts" class="col-md-12">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div class="selectors">                                 <div id="mobile-product-dropdown" class="dropdown"></div>                                 <div class="series-dropdown dropdown selector-dropdown"></div>                                 <div class="indicator-dropdown dropdown selector-dropdown"></div>                             </div>                             <div id="legend">                                 <svg id="tooltip"></svg>                             </div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row"></div>                 </div>             </div>         </div>     </div>',R={},T=ja(),U=v(),V={primary:void 0,secondaries:[],xAxis:ta.xAxis(),navbar:void 0,legend:ta.legend()},W=!1,X=.2,Y=!0,Z=b.util.render(c),$=!0;return R.fetchCoinbaseProducts=function(a){return arguments.length?(W=a,R):W},R.changeQuandlProduct=function(a){var b=wa.product(a,a,[T.periods.day1],T.sources.quandl,".3s"),c=T.headMenu.products.some(function(a){return a.id===b.id}),d=T.overlay.products.some(function(a){return a.id===b.id});c||T.headMenu.products.push(b),d||T.overlay.products.push(b),r(b),Y||Z()},R.proportionOfDataToDisplayByDefault=function(a){return arguments.length?(X=a,R):X},R.historicFeedErrorCallback=function(a){return arguments.length?(I=a,R):I},R.indicators=function(a){if(!arguments.length){var b=[];return T.selectors.indicatorSelector.options.forEach(function(a){a.isSelected&&b.push(a.valueString)}),b}return T.selectors.indicatorSelector.options.forEach(function(b){b.isSelected=a.some(function(a){return a===b.valueString})}),A(),Y?B():(C(),Z()),R},R.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var c=a.select(b);c.html(Q);var f=c.select("#charts"),g=c.select("#charts-container"),h=c.select("#overlay");H={app:c,charts:g,chartsAndOverlay:f,primary:g.select("#primary-container"),secondaries:g.selectAll(".secondary-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.selectAll(".overlay-secondary-container"),legend:c.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},V.primary=s(),V.navbar=t(),K=w(),M=u(),O=z(),J=D(),P=F(),d(),e(),U(T.headMenu.selectedPeriod.seconds,T.headMenu.selectedProduct),W?ka(G):T.sources.bitcoin&&delete T.sources.bitcoin},b.util.rebind(R,T.sources.quandl.historicFeed,{quandlApiKey:"apiKey"}),b.util.rebind(R,U,{periodsOfDataToFetch:"candlesOfData"}),R}a="default"in a?a["default"]:a,b="default"in b?b["default"]:b,c="default"in c?c["default"]:c;var na={centerOnDate:d,filterDataInDateRange:e,moveToLatest:f,trackingLatestData:g},oa=!1,pa=0,qa={domain:na,layout:h,uid:i,width:j,debounce:k,throttle:l},ra={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},sa={base:n,macd:o,rsi:p,volume:q},ta={legend:s,nav:r,primary:z,xAxis:t,secondary:sa},ua={head:E,selectors:F,navigationReset:G,overlay:I},va={toast:M},wa={period:O,product:P,source:Q},xa={head:U,periodAdaptor:B,productAdaptor:A,overlay:V,dropdownConfig:T,option:u,selector:W},ya={legend:X,nav:Y,navigationReset:Z,primary:$,secondary:_,xAxis:aa},za={message:N,messages:ba},Aa={menu:xa,chart:ya,data:wa,notification:za},Ba={app:ma},Ca=window.location.search.split("seed=")[1];Ca&&Math.seedrandom(Ca),Ba.app().fetchCoinbaseProducts(!1).quandlApiKey("ML1zzPw21E9-ddx9f5_y").run("#app-container")});