...
var g=a.time.saturday.ceil(b);if(g>c)return c.getTime()-b.getTime();var h=g.getTime()-b.getTime(),i=a.time.saturday.ceil(c),j=i.getTime()-c.getTime(),k=(i.getTime()-g.getTime())/e;return k*d+h-j},f.offset=function(c,e){var g=b(c)?f.clampUp(c):c,h=e;if(0>h){
//
var i=a.time.monday.floor(g);if(h-=i.getTime()-g.getTime(),h>=0)return new Date(g.getTime()+e);g=a.time.day.offset(i,-2);
// add all of the complete weeks to the date
var j=Math.floor(h/d);
// add the remaining time
return g=a.time.day.offset(g,7*j),h-=j*d,g=new Date(g.getTime()+h),g=a.time.day.offset(g,2)}
...
function e(a){j=a.series,n=a.yValueAccessor.option,p=a.indicators,d(),u.series(c()),x.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function f(a){var b=j.option.width(a);r.decorate(function(a){a.classed("band",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function g(a){a.classed("band",!1).selectAll("line").style("stroke-width",null)}function h(a){"candlestick"===j.valueString||"ohlc"===j.valueString?f(a):r.decorate(g)}function i(c){var d=c.datum();d.selectorsChanged&&e(d),x.xDomain(d.viewDomain),v.discontinuityProvider(ra.discontinuityProvider(d.product.source,d.sources.quandl)),r.snap(b.util.seriesPointSnapXOnly(j.option,d.data)),h(d.data),B(d.data),C(d.data);
// Scale y axis
...
var i=a.map();return i.set("Open","unadjustedOpen"),i.set("High","unadjustedHigh"),i.set("Low","unadjustedLow"),i.set("Close","unadjustedClose"),i.set("Volume","unadjustedVolume"),i.set("Adj. Open","open"),i.set("Adj. High","high"),i.set("Adj. Low","low"),i.set("Adj. Close","close"),i.set("Adj. Volume","volume"),d.candles=function(a){return arguments.length?(f=a,d):f},d.granularity=function(a){if(!arguments.length)return e;if(!h.has(a))throw new Error("Granularity of "+a+" is not supported.");return e=a,d},b.util.rebind(d,g,{end:"end",product:"dataset",apiKey:"apiKey"}),d}function ja(a){var b;return a&&a.quandl_error&&(b=a.quandl_error.message),b}function ka(){function c(){return{week1:Ba.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:Ba.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:Ba.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:Ba.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:Ba.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function d(){return{generated:Ba.data.source(ea(),null,null),bitcoin:Ba.data.source(fa(),ga,ha(),U),quandl:Ba.data.source(ia(),ja,null,null)}}function e(){return{generated:Ba.data.product("Data Generator","Data Generator",[j.day1],k.generated,".3s"),quandl:Ba.data.product("GOOG","GOOG",[j.day1,j.week1],k.quandl,".3s")}}function f(){var a=x();a.id=ra.uid();var c=Ba.menu.option("Candlestick","candlestick",a,"bf-icon-candlestick-series");c.isSelected=!0,c.option.extentAccessor=["high","low"];var d=b.series.ohlc();d.id=ra.uid();var e=Ba.menu.option("OHLC","ohlc",d,"bf-icon-ohlc-series");e.option.extentAccessor=["high","low"];var f=b.series.line().xValue(function(a){return a.date});f.id=ra.uid();var g=Ba.menu.option("Line","line",f,"bf-icon-line-series");g.option.extentAccessor="close";var h=b.series.point().xValue(function(a){return a.date});h.id=ra.uid();var i=Ba.menu.option("Point","point",h,"bf-icon-point-series");i.option.extentAccessor="close";var j=b.series.area().xValue(function(a){return a.date});j.id=ra.uid();var k=Ba.menu.option("Area","area",j,"bf-icon-area-series");k.option.extentAccessor="close";var l=Ba.menu.dropdownConfig(null,!1,!0,!0),m=[c,e,g,i,k];return Ba.menu.selector(l,m)}function g(){var a=ua.secondary,c=b.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).xValue(function(a){return a.date}).yValue(function(a){return a.movingAverage});c.id=ra.uid();var d=Ba.menu.option("Moving Average","movingAverage",c,"bf-icon-moving-average-indicator",!0);d.option.extentAccessor=function(a){return a.movingAverage};var e=b.indicator.renderer.bollingerBands();e.id=ra.uid();var f=Ba.menu.option("Bollinger Bands","bollinger",e,"bf-icon-bollinger-bands-indicator",!0);f.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var g=[d,f,Ba.menu.option("Relative Strength Index","rsi",a.rsi(),"bf-icon-rsi-indicator",!1),Ba.menu.option("MACD","macd",a.macd(),"bf-icon-macd-indicator",!1),Ba.menu.option("Volume","volume",a.volume(),"bf-icon-bar-series",!1)];return g}function h(){var a=Ba.menu.dropdownConfig("Add Indicator",!1,!0);return Ba.menu.selector(a,g())}function i(){return{seriesSelector:f(),indicatorSelector:h()}}var j=c(),k=d(),l=e();return{periods:j,sources:k,primaryChart:Ba.chart.primary(l.generated,k),secondaryChart:Ba.chart.secondary(l.generated,k),selectors:i(),xAxis:Ba.chart.xAxis(l.generated,j.day1,k),nav:Ba.chart.nav(l.generated,k),navReset:Ba.chart.navigationReset(),headMenu:Ba.menu.head([l.generated,l.quandl],l.generated,j.day1),legend:Ba.chart.legend(l.generated,j.day1),overlay:Ba.menu.overlay([l.generated,l.quandl],l.generated),notificationMessages:Ba.notification.messages()}}function la(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function ma(a,b,c,d){return a.map(function(a){return Ba.data.product(a.id,a.id,d.get(a.id)||c,b)})}function na(){function c(){W&&(W=!1),Y&&G.suspendLayout(!1),G.primary.datum(Q.primaryChart).call(S.primary),G.legend.datum(Q.legend).call(S.legend),G.secondaries.datum(Q.secondaryChart).filter(function(a,b){return b<S.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container secondary-"+S.secondaries[c].valueString).call(S.secondaries[c].option)}),G.xAxis.datum(Q.xAxis).call(S.xAxis),G.navbar.datum(Q.nav).call(S.navbar),G.app.select("#navbar-reset").datum(Q.navReset).call(J),G.app.select(".head-menu").datum(Q.headMenu).call(I),G.app.selectAll(".selectors").datum(Q.selectors).call(K),G.app.select("#notifications").datum(Q.notificationMessages).call(L),G.overlay.datum(Q.overlay).call(H),Y&&(G.suspendLayout(!0),Y=!1)}function d(){Y=!0,ra.layout(G,S)}function e(){a.select(window).on("resize",function(){d(),X()})}function f(a){Q.notificationMessages.messages.unshift(P(a))}function g(a){var b=[a[0],a[1]];Q.primaryChart.viewDomain=b,Q.secondaryChart.viewDomain=b,Q.xAxis.viewDomain=b,Q.nav.viewDomain=b;var c=ra.domain.trackingLatestData(Q.primaryChart.viewDomain,Q.primaryChart.data);Q.primaryChart.trackingLatest=c,Q.secondaryChart.trackingLatest=c,Q.nav.trackingLatest=c,Q.navReset.trackingLatest=c,X()}function h(a){a.isSelected=!a.isSelected,z(),X()}function i(a){a.isSelected=!a.isSelected,B(),X()}function j(a){Q.legend.data=a,X()}function k(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):U(a),c&&(f(c),X())}function l(){var a=Q.primaryChart.data,c=b.util.extent().fields("date")(a),d=ra.domain.moveToLatest(c,a,V);g(d)}function m(a,b){var c='<div class="spinner"></div>',d='<div class="content alert alert-info">'+b+"</div>";G.app.select("#loading-status-message").classed("hidden",!(a||b)).html(b?d:c)}function n(a){Q.primaryChart.data=a,Q.secondaryChart.data=a,Q.nav.data=a}function o(a){Q.headMenu.selectedProduct=a,Q.primaryChart.product=a,Q.secondaryChart.product=a,Q.legend.product=a,Q.overlay.selectedProduct=a,Q.xAxis.product=a,Q.nav.product=a}function p(a){Q.headMenu.selectedPeriod=a,Q.xAxis.period=a,Q.legend.period=a}function q(a){m(!0),o(a),p(a.periods[0]),R(a.periods[0].seconds,a)}function r(){return ua.primary().on(sa.crosshairChange,j).on(sa.viewChange,g)}function s(){return ua.nav().on(sa.viewChange,g)}function t(){return va.navigationReset().on(sa.resetToLatest,l)}function u(){return N().on(sa.newTrade,function(a,b){if(n(a),Q.primaryChart.trackingLatest){var c=ra.domain.moveToLatest(Q.primaryChart.viewDomain,Q.primaryChart.data);g(c)}}).on(sa.historicDataLoaded,function(a,b){m(!1),n(a),Q.legend.data=null,l(),d()}).on(sa.historicFeedError,function(a,b){m(!1,"Error loading data. Please make your selection again, or refresh the page.");var c="";try{var d=JSON.parse(a.responseText),e=b.historicNotificationFormatter(d);e&&(c=". "+e)}catch(g){c=""}var h=a.statusText||"Unknown reason.",i="Error getting historic data: "+h+c;f(i),X()}).on(sa.streamingFeedError,k).on(sa.streamingFeedClose,k)}function v(){return va.head().on(sa.dataProductChange,function(a){q(a.option),X()}).on(sa.dataPeriodChange,function(a){m(!0),p(a.option),R(a.option.seconds),X()}).on(sa.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){Q.primaryChart.indicators.forEach(x),S.secondaries.forEach(x),z(),B(),X()})}function w(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function x(a){a.isSelected=!1}function y(){return va.selectors().on(sa.primaryChartSeriesChange,function(a){Q.primaryChart.series=a,w(a,Q.selectors.seriesSelector.options),X()}).on(sa.primaryChartIndicatorChange,h).on(sa.secondaryChartChange,i)}function z(){Q.primaryChart.indicators=Q.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),Q.overlay.primaryIndicators=Q.primaryChart.indicators}function A(){S.secondaries=Q.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),
// TODO: This doesn't seem to be a concern of menu.
S.secondaries.forEach(function(a){a.option.on(sa.viewChange,g)}),Q.overlay.secondaryIndicators=S.secondaries}function B(){A(),
// TODO: Remove .remove! (could a secondary chart group component manage this?).
G.secondaries.selectAll("*").remove(),d()}function C(){return va.overlay().on(sa.primaryChartIndicatorChange,h).on(sa.secondaryChartChange,i).on(sa.dataProductChange,function(a){q(a.option),X()})}function D(a){Q.notificationMessages.messages=Q.notificationMessages.messages.filter(function(b){return b.id!==a}),X()}function E(){return wa.toast().on(sa.notificationClose,D)}function F(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;Q.notificationMessages.messages.unshift(P(e))}else{var f=[Q.periods.hour1,Q.periods.day1],g=a.map();g.set("BTC-USD",[Q.periods.minute1,Q.periods.minute5,Q.periods.hour1,Q.periods.day1]);var h=ma(c,Q.sources.bitcoin,f,g);Q.headMenu.products=Q.overlay.products=Q.headMenu.products.concat(h)}X()}var G,H,I,J,K,L,M='<div class="container-fluid">         <div id="notifications"></div>         <div id="loading-status-message"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div class="selectors">                     <div class="series-dropdown dropdown selector-dropdown"></div>                     <div class="indicator-dropdown dropdown selector-dropdown"></div>                     <div id="mobile-period-selector" class="dropdown"></div>                 </div>                 <div id="period-selector"></div>                 <span id="clear-indicators" class="icon bf-icon-delete delete-button"></span>             </div>         </div>         <div class="row primary-row">             <div id="charts" class="col-md-12">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div class="selectors">                                 <div id="mobile-product-dropdown" class="dropdown"></div>                                 <div class="series-dropdown dropdown selector-dropdown"></div>                                 <div class="indicator-dropdown dropdown selector-dropdown"></div>                             </div>                             <div id="legend">                                 <svg id="tooltip"></svg>                             </div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row"></div>                 </div>             </div>         </div>     </div>',O={},Q=ka(),R=u(),S={primary:void 0,secondaries:[],xAxis:ua.xAxis(),navbar:void 0,legend:ua.legend()},T=!1,V=.2,W=!0,X=b.util.render(c),Y=!0;return O.fetchCoinbaseProducts=function(a){return arguments.length?(T=a,O):T},O.changeQuandlProduct=function(a){var b=xa.product(a,a,[Q.periods.day1],Q.sources.quandl,".3s"),c=Q.headMenu.products.some(function(a){return a.id===b.id}),d=Q.overlay.products.some(function(a){return a.id===b.id});c||Q.headMenu.products.push(b),d||Q.overlay.products.push(b),q(b),W||X()},O.proportionOfDataToDisplayByDefault=function(a){return arguments.length?(V=a,O):V},O.indicators=function(a){if(!arguments.length){var b=[];return Q.selectors.indicatorSelector.options.forEach(function(a){a.isSelected&&b.push(a.valueString)}),b}return Q.selectors.indicatorSelector.options.forEach(function(b){b.isSelected=a.some(function(a){return a===b.valueString})}),z(),W?A():(B(),X()),O},O.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var c=a.select(b);c.html(M);var f=c.select("#charts"),g=c.select("#charts-container"),h=c.select("#overlay");G={app:c,charts:g,chartsAndOverlay:f,primary:g.select("#primary-container"),secondaries:g.selectAll(".secondary-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.selectAll(".overlay-secondary-container"),legend:c.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},S.primary=r(),S.navbar=s(),I=v(),J=t(),K=y(),H=C(),L=E(),d(),e(),R(Q.headMenu.selectedPeriod.seconds,Q.headMenu.selectedProduct),T?la(F):Q.sources.bitcoin&&delete Q.sources.bitcoin},b.util.rebind(O,Q.sources.quandl.historicFeed,{quandlApiKey:"apiKey"}),b.util.rebind(O,R,{periodsOfDataToFetch:"candlesOfData"}),O}a="default"in a?a["default"]:a,b="default"in b?b["default"]:b,c="default"in c?c["default"]:c;var oa={centerOnDate:d,filterDataInDateRange:e,moveToLatest:f,trackingLatestData:g},pa=!1,qa=0,ra={domain:oa,layout:h,uid:i,width:j,debounce:k,throttle:l,discontinuityProvider:n},sa={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},ta={base:p,macd:q,rsi:r,volume:s},ua={legend:u,nav:t,primary:B,xAxis:v,secondary:ta},va={head:G,selectors:H,navigationReset:I,overlay:K},wa={toast:O},xa={period:Q,product:R,source:S},ya={head:W,periodAdaptor:D,productAdaptor:C,overlay:X,dropdownConfig:V,option:w,selector:Y},za={legend:Z,nav:$,navigationReset:_,primary:aa,secondary:ba,xAxis:ca},Aa={message:P,messages:da},Ba={menu:ya,chart:za,data:xa,notification:Aa},Ca={app:na},Da=window.location.search.split("seed=")[1];Da&&Math.seedrandom(Da),Ca.app().fetchCoinbaseProducts(!0).run("#app-container")});