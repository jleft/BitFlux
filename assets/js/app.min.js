...
!function(a,b){"object"==typeof exports&&"undefined"!=typeof module?b(require("d3"),require("d3fc"),require("jquery")):"function"==typeof define&&define.amd?define(["d3","d3fc","jquery"],b):b(a.d3,a.fc,a.$)}(this,function(a,b,c){"use strict";function d(a,c,d,e){var f=b.util.extent().fields("date")(d),g=b.util.extent().fields(b.util.fn.identity)(c),h=a.distance(g[0],g[1]);if(e.getTime()<f[0]||e.getTime()>f[1])
// TODO: is this tested by unit tests?
return g;var i=[a.offset(e,-h/2),a.offset(e,h/2)],j=0;return i[1].getTime()>f[1].getTime()?j=f[1].getTime()-i[1].getTime():i[0].getTime()<f[0].getTime()&&(j=f[0].getTime()-i[0].getTime()),[a.offset(i[0],j),a.offset(i[1],j)]}function e(b,c){var d=a.min(b,function(a){return a.getTime()}),e=a.max(b,function(a){return a.getTime()}),f=c.sort(function(a,b){return a.date-b.date}),g=a.bisector(function(a){return a.date}),h=c.slice(
...
function m(){function b(a){return 0===a.getDay()||6===a.getDay()}var c=864e5,d=5*c,e=7*c,f={};
