...
j=j.filter(function(){return this.parentNode===g.node()}));var k=j.data(i,f),l=k.enter().insert(d).attr(e).style("opacity",Fc),m=a.transition(k.exit()).style("opacity",Fc).remove();
...
sb(this)})}function vb(){return++bd}function wb(a,b){function c(b){return a.secondaries.filter(function(a,c){return c===b})}for(var d=0,e=0;e<b.secondaries.length;e++)b.secondaries[e]&&d++;a.secondaries.filter(function(a,b){return d>b}).style("flex","1"),a.secondaries.filter(function(a,b){return b>=d}).style("flex","0"),a.overlaySecondaries.filter(function(a,b){return d>b}).style("flex","1"),a.overlaySecondaries.filter(function(a,b){return b>=d}).style("flex","0");var f=parseInt(a.app.select(".head-row").style("height"),10);cd||(f+=parseInt(a.app.select(".head-row").style("padding-top"),10)+parseInt(a.app.select(".head-row").style("padding-bottom"),10)+parseInt(a.app.select(".head-row").style("margin-bottom"),10),cd=!0);var g=ad.util.innerDimensions(a.app.node()).height-f;a.chartsAndOverlay.style("height",g+"px"),b.xAxis.dimensionChanged(a.xAxis),b.navbar.dimensionChanged(a.navbar),b.primary.dimensionChanged(a.primary);for(var h=0;h<b.secondaries.length;h++)b.secondaries[h].option.dimensionChanged(c(h))}function xb(b,c){var d=a.max(b,function(a){return a.getTime()}),e=a.max(c,function(a){return a.date.getTime()});return d===e}function yb(b,c,d){arguments.length<3&&(d=1);var e=ad.util.extent().fields("date")(c),f=(e[1].getTime()-e[0].getTime())/1e3,g=b.map(function(a){return a.getTime()}),h=d*(a.max(g)-a.min(g))/1e3,i=f>h?[a.time.second.offset(e[1],-h),e[1]]:e;return i}function zb(b,c){var d=a.min(b,function(a){return a.getTime()}),e=a.max(b,function(a){return a.getTime()}),f=c.sort(function(a,b){return a.date-b.date}),g=a.bisector(function(a){return a.date}),h=c.slice(
// Pad and clamp the bisector values to ensure extents can be calculated
Math.max(0,g.left(f,d)-1),Math.min(g.right(f,e)+1,f.length));return h}function Ab(b,c,d){var e=ad.util.extent().fields("date")(c),f=b.map(function(a){return a.getTime()}),g=(a.max(f)-a.min(f))/1e3;if(d.getTime()<e[0]||d.getTime()>e[1])return[new Date(a.min(f)),new Date(a.max(f))];var h=[a.time.second.offset(d,-g/2),a.time.second.offset(d,g/2)],i=0;return h[1].getTime()>e[1].getTime()?i=(e[1].getTime()-h[1].getTime())/1e3:h[0].getTime()<e[0].getTime()&&(i=(e[0].getTime()-h[0].getTime())/1e3),[a.time.second.offset(h[0],i),a.time.second.offset(h[1],i)]}function Bb(b){function c(a){
// Don't pan off sides
// Don't pan off sides
return a[0]>=0?-a[0]:a[1]<=0?-a[1]:0}function d(a){
// If zooming, and about to pan off screen, do nothing
return a[0]>0&&a[1]<0}function e(a){var b=j.translate()[0];b+=a,j.translate([b,0])}function f(){j.translate([0,0]),j.scale(1)}function g(a){var g=ad.util.extent().fields("date")(a.datum().data);j.x(h).on("zoom",function(){var n=h(g[0]),o=h(g[1]),p=d([n,o-b]),q=c([n,o-b]);e(q);var r=1===j.scale(),s=1!==j.scale();if(r&&k||s&&l){var t=h.domain();p?t=g:s&&m&&(t=ed.domain.moveToLatest(t,a.datum().data)),t[0].getTime()!==t[1].getTime()?i.zoom(t):
// Ensure the user can't zoom-in infinitely, causing the chart to fail to render
// #168, #411
f()}else f()}),a.call(j)}var h,i=a.dispatch("zoom"),j=a.behavior.zoom(),k=!0,l=!0,m=!0;return g.allowPan=function(a){return arguments.length?(k=a,g):k},g.allowZoom=function(a){return arguments.length?(l=a,g):l},g.trackingLatest=function(a){return arguments.length?(m=a,g):m},g.scale=function(a){return arguments.length?(h=a,g):h},a.rebind(g,i,"on"),g}function Cb(){function b(b){b.each(function(f){var h=a.select(this).call(j),i=Bb(c).scale(e).trackingLatest(g).on("zoom",function(a){d[fd.viewChange](a)});h.select(".plot-area-container").datum({data:b.datum()}).call(i)})}var c,d=a.dispatch(fd.viewChange),e=ad.scale.dateTime(),f=a.scale.linear(),g=!0,h=60,i=ad.series.multi(),j=ad.chart.cartesian(e,f).plotArea(i).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:h});return b.trackingLatest=function(a){return arguments.length?(g=a,b):g},a.rebind(b,d,"on"),a.rebind(b,i,"series","mapping","decorate"),a.rebind(b,j,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),b.dimensionChanged=function(a){c=parseInt(a.style("width"),10)-h},b}function Db(){function b(a){a.each(function(b){var c=ad.util.extent().fields("volume").pad(.08)(b.data);c[0]<0&&(c[0]=0),e.yTickFormat(b.product.volumeFormat).trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain(c),a.datum(b.data).call(e)})}var c=a.dispatch(fd.viewChange),d=ad.series.bar().yValue(function(a){return a.volume}),e=Cb().series([d]).yTicks(4).on(fd.viewChange,function(a){c[fd.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){e.dimensionChanged(a)},b}function Eb(){function b(a){var b=a.datum();e(b.data),g.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.datum(b.data).call(g)}var c=a.dispatch(fd.viewChange),d=ad.indicator.renderer.relativeStrengthIndex(),e=ad.indicator.algorithm.relativeStrengthIndex(),f=[d.lowerValue(),50,d.upperValue()],g=Cb().series([d]).yTickValues(f).on(fd.viewChange,function(a){c[fd.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){g.dimensionChanged(a)},b}function Fb(){function b(a){var b=a.datum();f(b.data);var c=ad.util.extent().fields("macd").symmetricalAbout(0).pad(.08)(b.data.map(function(a){return a.macd}));g.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain(c),a.datum(b.data).call(g)}var c=a.dispatch(fd.viewChange),d=ad.annotation.line().value(0).label(""),e=ad.indicator.renderer.macd(),f=ad.indicator.algorithm.macd(),g=Cb().series([d,e]).yTicks(5).mapping(function(a){return a===d?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(fd.viewChange,function(a){c[fd.viewChange](a)});return a.rebind(b,c,"on"),b.dimensionChanged=function(a){g.dimensionChanged(a)},b}function Gb(){function b(a){var b=(d.ticks()[1]-d.ticks()[0])/1e3;b<a.seconds?e.ticks(a.d3TimeInterval.unit,a.d3TimeInterval.value):e.ticks(6)}function c(a){var c=a.datum();d.domain(c.viewDomain),b(c.period),a.call(e)}var d=ad.scale.dateTime(),e=a.svg.axis().scale(d).orient("bottom");return c.dimensionChanged=function(a){d.range([0,parseInt(a.style("width"),10)])},c}function Hb(a,b,c,d,e){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d,isPrimary:e}}function Ib(){var b=ad.scale.dateTime(),c=a.scale.linear(),d=ad.util.fractionalBarWidth(.75),e=function(a,b){return a.date},f=function(a,c){return b(e(a,c))},g=function(a){return a.low},h=function(a){return a.high},i=function(a,b){return a.close},j=ad.svg.candlestick().x(function(a){return b(a.date)}).open(function(a){return c(a.open)}).high(function(a){return c(h(a))}).low(function(a){return c(g(a))}).close(function(a){return c(a.close)}),k=ad.util.dataJoin().selector("path.up").element("path").attr("class","up"),l=ad.util.dataJoin().selector("path.down").element("path").attr("class","down"),m=function(a){a.each(function(a){j.width(d(a.map(f)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});k(this,[b]).attr("d",j),l(this,[c]).attr("d",j)})};return m.xScale=function(a){return arguments.length?(b=a,m):b},m.yScale=function(a){return arguments.length?(c=a,m):c},m.xValue=function(a){return arguments.length?(e=a,m):e},m.yLowValue=function(a){return arguments.length?(g=a,m):g},m.yHighValue=function(a){return arguments.length?(h=a,m):h},m.yCloseValue=function(a){return arguments.length?(i=a,m):i},m.width=function(a){return d(a.map(f))},m}function Jb(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function Kb(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function Lb(a){return a.reduce(function(a,b){return b.extentAccessor?a.concat(b.extentAccessor):a},[])}function Mb(){function b(){var a=[q,i.option,r],b=n.map(function(a){return a.option});return a.concat(b,p)}function c(){switch(w.value(m),x.value(m),r.value(m),i.valueString){case"line":case"point":case"area":i.option.yValue(m)}}
// Call when what to display on the chart is modified (ie series, options)
function d(a){i=a.series,m=a.yValueAccessor.option,n=a.indicators,c(),s.series(b()),v.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function e(a){var b=i.option.width(a);p.decorate(function(a){a.classed("band hidden-xs hidden-sm",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function f(a){a.classed("band",!1).classed("hidden-xs hidden-sm",!0).selectAll("line").style("stroke-width",null)}function g(a){"candlestick"===i.valueString||"ohlc"===i.valueString?e(a):p.decorate(f)}function h(b){var c=b.datum();c.selectorsChanged&&d(c),v.xDomain(c.viewDomain),p.snap(ad.util.seriesPointSnapXOnly(i.option,c.data)),g(c.data),w(c.data),x(c.data);
// Scale y axis
var e=ed.domain.filterDataInDateRange(v.xDomain(),c.data),f=Lb(s.series()),h=ad.util.extent().fields(f).pad(.08)(e);v.yDomain(h);
...
// Redraw
v.plotArea(s),b.call(v);var q=Bb(j).scale(t).trackingLatest(c.trackingLatest).on("zoom",function(a){l[fd.viewChange](a)});b.select(".plot-area").call(q)}var i,j,k=60,l=a.dispatch(fd.viewChange,fd.crosshairChange),m=function(a){return a.close},n=[],o=[],p=ad.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?l.crosshairChange(a[0].datum):l.crosshairChange(void 0)}).on("trackingend",function(){l.crosshairChange(void 0)});p.id=ed.uid();var q=ad.annotation.gridline().yTicks(5).xTicks(0),r=ad.annotation.line().orient("horizontal").value(m).label("");r.id=ed.uid();var s=ad.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case r:return[this.data[this.data.length-1]];case p:return o;default:return this.data}}),t=ad.scale.dateTime(),u=a.scale.linear(),v=ad.chart.cartesian(t,u).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:k}),w=ad.indicator.algorithm.movingAverage(),x=ad.indicator.algorithm.bollingerBands();
// Call when the main layout is modified
return a.rebind(h,l,"on"),h.dimensionChanged=function(a){j=parseInt(a.style("width"),10)-k},h}function Nb(){function b(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function c(a){return a.extent()[0][0]-a.extent()[1][0]===0}function d(a,b){var c=a.selectAll("defs").data([0]).enter().append("defs");c.html('<linearGradient id="brush-gradient" x1="0" x2="0" y1="0" y2="1">               <stop offset="0%" class="brush-gradient-top" />               <stop offset="100%" class="brush-gradient-bottom" />           </linearGradient>           <mask id="brush-mask">               <rect class="mask-background"></rect>           </mask>'),a.select(".mask-background").attr({width:f,height:i}),w.domain(ad.util.extent().fields("date")(b)),x.domain(ad.util.extent().fields(["low","high"])(b)),a.select("mask").datum(b).call(y)}function e(a){var e=a.datum();d(a,e.data),r.domain(e.viewDomain);var g=ed.domain.filterDataInDateRange(ad.util.extent().fields("date")(e.data),e.data),h=ad.util.extent().fields(["low","high"])(g);q.xDomain(ad.util.extent().fields("date")(e.data)).yDomain(h),u.on("brush",function(){var d=c(u);
// Hide the bar if the extent is empty
b(a,d),d||p[fd.viewChange]([u.extent()[0][0],u.extent()[1][0]])}).on("brushend",function(){var d=c(u);b(a,!1),d&&p[fd.viewChange](ed.domain.centerOnDate(r.domain(),e.data,u.extent()[0][0]))}),q.plotArea(v),a.call(q);
// Allow to zoom using mouse, but disable panning
var i=Bb(f).scale(r).trackingLatest(e.trackingLatest).allowPan(!1).on("zoom",function(a){p[fd.viewChange](a)});a.select(".plot-area").call(i)}var f,g=100,h=40,i=g-h,j=2,k=j/2,l=i-k,m=l,n=k+m/2,o=2,p=a.dispatch(fd.viewChange),q=ad.chart.cartesian(ad.scale.dateTime(),a.scale.linear()).yTicks(0).margin({bottom:h}),r=ad.scale.dateTime(),s=ad.series.area().yValue(function(a){return a.close}),t=ad.series.line().yValue(function(a){return a.close}),u=a.svg.brush(),v=ad.series.multi().series([s,t,u]).decorate(function(a){var b=a.enter();a.select(".extent").attr("height",l).attr("y",j/2),
...
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",n).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",n).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a!==u?this.data:void u.extent([[r.domain()[0],q.yDomain()[0]],[r.domain()[1],q.yDomain()[1]]])}),w=ad.scale.dateTime(),x=a.scale.linear(),y=ad.series.area().yValue(function(a){return a.close}).xScale(w).yScale(x);return a.rebind(e,p,"on"),e.dimensionChanged=function(a){f=parseInt(a.style("width"),10),r.range([0,f]),w.range([0,f]),x.range([i,0])},e}function Ob(){function b(b){b.each(function(b){var h=a.select(this);if(c=b.product.priceFormat,d=b.product.volumeFormat,e=b.period.timeFormat,null==b.data||b.data!==f){f=b.data;var i=h.selectAll("span").data(g);i.enter().append("span").attr("class",function(a,b){return b%2===0?"legendLabel":"legendValue"}),i.text(function(a,c){var d="";return c%2===0?a:b.data?a(b.data):d})}})}var c,d,e,f,g=["T",function(a){return e(a.date)},"O",function(a){return c(a.open)},"H",function(a){return c(a.high)},"L",function(a){return c(a.low)},"C",function(a){return c(a.close)},"V",function(a){return d(a.volume)}];return b}function Pb(){function b(b){b.each(function(b){var d=a.select(this),e=d.selectAll("div").data(b.selectedIndicators,function(a){return a.valueString}),f=e.enter().append("div").attr("class","edit-indicator");f.append("span").attr("class","icon sc-icon-delete").on("click",c.indicatorChange),f.append("span").attr("class","indicator-label").text(function(a){return a.displayString}),e.exit().remove()})}var c=a.dispatch(fd.indicatorChange);return a.rebind(b,c,"on"),b}function Qb(){var b=a.dispatch(fd.primaryChartIndicatorChange,fd.secondaryChartChange),c=Pb().on(fd.indicatorChange,b[fd.primaryChartIndicatorChange]),d=Pb().on(fd.indicatorChange,b[fd.secondaryChartChange]),e=function(b){b.each(function(b){var e=a.select(this);e.select("#overlay-primary-container .edit-indicator-container").datum({selectedIndicators:b.primaryIndicators}).call(c),e.selectAll(".overlay-secondary-container").each(function(c,e){var f=a.select(this),g=b.secondaryIndicators[e]?[b.secondaryIndicators[e]]:[];f.select(".edit-indicator-container").datum({selectedIndicators:g}).call(d)})})};return a.rebind(e,b,"on"),e}function Rb(){function b(a){var b=a.datum(),d=a.selectAll("g").data([b]);d.enter().append("g").attr("class","reset-button").on("click",function(){c[fd.resetToLatest]()}).append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),d.classed("active",!b.trackingLatest)}var c=a.dispatch(fd.resetToLatest);return a.rebind(b,c,"on"),b}function Sb(){function b(a){var b=a.datum(),h=b.selectedIndex||0,i=b.config,j=d(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[h].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[h].displayString});e(j,i.careted?[0]:[]);var l=f(a,[b.options]),m=g(l,b.options),n=m.enter().on("click",c.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var c=a.dispatch("optionChange"),d=ad.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),e=ad.util.dataJoin().selector(".caret").element("span").attr("class","caret"),f=ad.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),g=ad.util.dataJoin().selector("li").element("li").key(function(a){return a.displayString});return a.rebind(b,c,"on"),b}function Tb(){var b=a.dispatch(fd.primaryChartSeriesChange,fd.primaryChartIndicatorChange,fd.secondaryChartChange),c=Sb().on("optionChange",b[fd.primaryChartSeriesChange]),d=Sb().on("optionChange",function(a){a.isPrimary?b[fd.primaryChartIndicatorChange](a):b[fd.secondaryChartChange](a)}),e=function(b){b.each(function(b){var e=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);e.select("#series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(c);var g=b.indicatorSelector.options,h=g.map(function(a,b){return a.isSelected?b:null}).filter(function(a){return a});e.select("#indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selected:h}).call(d)})};return a.rebind(e,b,"on"),e}
...
!b||b.readyState!==WebSocket.CONNECTING&&b.readyState!==WebSocket.OPEN||b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f}function wc(){function b(b){var g=a.time.second.offset(e.end(),-d*c);e.start(g).collapse(f.get(c)),e(b)}var c,d,e=ad.data.feed.quandl(),f=a.map();return f.set(86400,"daily"),f.set(604800,"weekly"),b.candles=function(a){return arguments.length?(d=a,b):d},b.granularity=function(a){if(!arguments.length)return c;if(!f.has(a))throw new Error("Granularity of "+a+" is not supported.");return c=a,b},ad.util.rebind(b,e,{end:"end",product:"dataset"}),b}function xc(a){var b;return a&&a.quandl_error&&(b=a.quandl_error.message),b}function yc(){function b(){return{week1:od.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:od.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:od.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:od.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:od.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function c(){return{generated:od.data.source(rc(),null,null),bitcoin:od.data.source(tc(),uc,vc(),fc),quandl:od.data.source(wc(),xc,null,null)}}function d(){return{generated:od.data.product(null,"Data Generator",[i.day1],j.generated,".3s"),quandl:od.data.product("GOOG","GOOG",[i.day1,i.week1],j.quandl,".3s")}}function e(){var a=Ib();a.id=ed.uid();var b=od.menu.option("Candlestick","candlestick",a,"sc-icon-candlestick-series");b.isSelected=!0,b.option.extentAccessor=["high","low"];var c=ad.series.ohlc();c.id=ed.uid();var d=od.menu.option("OHLC","ohlc",c,"sc-icon-ohlc-series");d.option.extentAccessor=["high","low"];var e=ad.series.line();e.id=ed.uid();var f=od.menu.option("Line","line",e,"sc-icon-line-series");f.option.extentAccessor="close";var g=ad.series.point();g.id=ed.uid();var h=od.menu.option("Point","point",g,"sc-icon-point-series");h.option.extentAccessor="close";var i=ad.series.area();i.id=ed.uid();var j=od.menu.option("Area","area",i,"sc-icon-area-series");j.option.extentAccessor="close";var k=od.menu.dropdownConfig(null,!1,!0,!0),l=[b,d,f,h,j];return od.menu.selector(k,l)}function f(){var a=hd.secondary,b=ad.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).yValue(function(a){return a.movingAverage});b.id=ed.uid();var c=od.menu.option("Moving Average","movingAverage",b,"sc-icon-moving-average-indicator",!0);c.option.extentAccessor=function(a){return a.movingAverage};var d=ad.indicator.renderer.bollingerBands();d.id=ed.uid();var e=od.menu.option("Bollinger Bands","bollinger",d,"sc-icon-bollinger-bands-indicator",!0);e.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var f=[c,e,od.menu.option("Relative Strength Index","secondary-rsi",a.rsi(),"sc-icon-rsi-indicator",!1),od.menu.option("MACD","secondary-macd",a.macd(),"sc-icon-macd-indicator",!1),od.menu.option("Volume","secondary-volume",a.volume(),"sc-icon-bar-series",!1)];return f}function g(){var a=od.menu.dropdownConfig("Add Indicator",!1,!0);return od.menu.selector(a,f())}function h(){return{seriesSelector:e(),indicatorSelector:g()}}var i=b(),j=c(),k=d();return{periods:i,sources:j,primaryChart:od.chart.primary(k.generated),secondaryChart:od.chart.secondary(k.generated),selectors:h(),xAxis:od.chart.xAxis(i.day1),nav:od.chart.nav(),navReset:od.chart.navigationReset(),headMenu:od.menu.head([k.generated,k.quandl],k.generated,i.day1),legend:od.chart.legend(k.generated,i.day1),overlay:od.menu.overlay(),notificationMessages:od.notification.messages()}}function zc(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function Ac(a,b,c,d){return a.map(function(a){return od.data.product(a.id,a.id,d.get(a.id)||c,b)})}function Bc(){function b(){Q&&(Q=!1),S&&E.suspendLayout(!1),E.primary.datum(N.primaryChart).call(O.primary),E.legend.datum(N.legend).call(O.legend),E.secondaries.datum(N.secondaryChart).filter(function(a,b){return b<O.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container "+O.secondaries[c].valueString).call(O.secondaries[c].option)}),E.xAxis.datum(N.xAxis).call(O.xAxis),E.navbar.datum(N.nav).call(O.navbar),E.app.select("#navbar-reset").datum(N.navReset).call(I),E.app.select(".head-menu").datum(N.headMenu).call(H),E.app.select("#selectors").datum(N.selectors).call(J),E.app.select("#notifications").datum(N.notificationMessages).call(K),E.overlay.datum(N.overlay).call(G),S&&(E.suspendLayout(!0),S=!1)}function c(){S=!0,ed.layout(E,O)}function d(){a.select(window).on("resize",function(){c(),R()})}function e(a){N.notificationMessages.messages.unshift(ac(a))}function f(a){var b=[a[0],a[1]];N.primaryChart.viewDomain=b,N.secondaryChart.viewDomain=b,N.xAxis.viewDomain=b,N.nav.viewDomain=b;var c=ed.domain.trackingLatestData(N.primaryChart.viewDomain,N.primaryChart.data);N.primaryChart.trackingLatest=c,N.secondaryChart.trackingLatest=c,N.nav.trackingLatest=c,N.navReset.trackingLatest=c,R()}function g(a){a.isSelected=!a.isSelected,y(),R()}function h(a){a.isSelected=!a.isSelected,z(),R()}function i(a){N.legend.data=a,R()}function j(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):fc(a),c&&(e(c),R())}function k(){var a=N.primaryChart.data,b=ad.util.extent().fields("date")(a),c=ed.domain.moveToLatest(b,a,.2);f(c)}function l(a,b){E.app.select("#loading-status-message").classed("hidden",!(a||b)).select(".content").text(b||"Loading..."),E.app.select("#charts").classed("hidden",a||b)}function m(a){N.primaryChart.data=a,N.secondaryChart.data=a,N.nav.data=a}function n(a){N.headMenu.selectedProduct=a,N.primaryChart.product=a,N.secondaryChart.product=a,N.legend.product=a}function o(a){N.headMenu.selectedPeriod=a,N.xAxis.period=a,N.legend.period=a}function p(a){l(!0),n(a),o(a.periods[0]),F(a.periods[0].seconds,a)}function q(){return hd.primary().on(fd.crosshairChange,i).on(fd.viewChange,f)}function r(){return hd.nav().on(fd.viewChange,f)}function s(){return id.navigationReset().on(fd.resetToLatest,k)}function t(){return $b().on(fd.newTrade,function(a,b){if(m(a),N.primaryChart.trackingLatest){var c=ed.domain.moveToLatest(N.primaryChart.viewDomain,N.primaryChart.data);f(c)}}).on(fd.historicDataLoaded,function(a,b){l(!1),m(a),N.legend.data=null,k(),c()}).on(fd.historicFeedError,function(a,b){l(!1,"Error loading data. Please make your selection again, or refresh the page.");var c="";try{var d=JSON.parse(a.responseText),f=b.historicNotificationFormatter(d);f&&(c=". "+f)}catch(g){c=""}var h=a.statusText||"Unknown reason.",i="Error getting historic data: "+h+c;e(i),R()}).on(fd.streamingFeedError,j).on(fd.streamingFeedClose,j)}function u(){return id.head().on(fd.dataProductChange,function(a){p(a.option),R()}).on(fd.dataPeriodChange,function(a){l(!0),o(a.option),F(a.option.seconds),R()}).on(fd.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){N.primaryChart.indicators.forEach(w),O.secondaries.forEach(w),y(),z(),R()})}function v(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function w(a){a.isSelected=!1}function x(){return id.selectors().on(fd.primaryChartSeriesChange,function(a){N.primaryChart.series=a,v(a,N.selectors.seriesSelector.options),R()}).on(fd.primaryChartIndicatorChange,g).on(fd.secondaryChartChange,h)}function y(){N.primaryChart.indicators=N.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),N.overlay.primaryIndicators=N.primaryChart.indicators}function z(){O.secondaries=N.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),
// TODO: This doesn't seem to be a concern of menu.
O.secondaries.forEach(function(a){a.option.on(fd.viewChange,f)}),N.overlay.secondaryIndicators=O.secondaries,
// TODO: Remove .remove! (could a secondary chart group component manage this?).
E.secondaries.selectAll("*").remove(),c()}function A(){return id.overlay().on(fd.primaryChartIndicatorChange,g).on(fd.secondaryChartChange,h)}function B(a){N.notificationMessages.messages=N.notificationMessages.messages.filter(function(b){return b.id!==a}),R()}function C(){return jd.toast().on(fd.notificationClose,B)}function D(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;N.notificationMessages.messages.unshift(ac(e))}else{var f=[N.periods.hour1,N.periods.day1],g=a.map();g.set("BTC-USD",[N.periods.minute1,N.periods.minute5,N.periods.hour1,N.periods.day1]);var h=Ac(c,N.sources.bitcoin,f,g);N.headMenu.products=N.headMenu.products.concat(h)}}var E,F,G,H,I,J,K,L='<div class="container-fluid">         <div id="notifications"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div id="period-selector" class="hidden-xs hidden-sm"></div>                 <div id="mobile-period-selector" class="hidden-md hidden-lg dropdown"></div>                 <span id="clear-indicators" class="icon sc-icon-delete delete-button hidden-md hidden-lg"></span>             </div>         </div>         <div class="row primary-row">             <div class="col-md-12" id="loading-status-message">                 <p class="content">Loading...</p>             </div>             <div id="charts" class="col-md-12 hidden">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row" class="hidden-xs hidden-sm">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div id="selectors">                                 <div id="series-dropdown" class="dropdown selector-dropdown"></div>                                 <div id="indicator-dropdown" class="dropdown selector-dropdown"></div>                             </div>                             <div id="legend" class="hidden-xs hidden-sm"></div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row" class="hidden-xs hidden-sm"></div>                 </div>             </div>         </div>     </div>',M={},N=yc(),O={primary:void 0,secondaries:[],xAxis:hd.xAxis(),navbar:void 0,legend:hd.legend()},P=!1,Q=!0,R=ad.util.render(b),S=!0;return M.fetchCoinbaseProducts=function(a){return arguments.length?(P=a,M):P},M.changeQuandlProduct=function(a){var b=kd.product(a,a,[N.periods.day1],N.sources.quandl,".3s"),c=N.headMenu.products.some(function(a){return a.id===b.id});c||N.headMenu.products.push(b),p(b),Q||R()},M.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var e=a.select(b);e.html(L);var f=e.select("#charts"),g=e.select("#charts-container"),h=e.select("#overlay");E={app:e,charts:g,chartsAndOverlay:f,primary:g.select("#primary-container"),secondaries:g.selectAll(".secondary-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.selectAll(".overlay-secondary-container"),legend:e.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},O.primary=q(),O.navbar=r(),F=t(),H=u(),I=s(),J=x(),G=A(),K=C(),c(),d(),F(N.headMenu.selectedPeriod.seconds,N.headMenu.selectedProduct),P?zc(D):N.sources.bitcoin&&delete N.sources.bitcoin},M}a="default"in a?a["default"]:a;var Cc=Object.freeze({randomItem:o,randomIndex:p,cloneAndReplace:q}),Dc={boundingBox:u,greedy:t,local:s,annealing:r},Ec=Object.freeze({context:v,identity:w,index:x,noop:y}),Fc=1e-6,Gc=Object.freeze({isOrdinal:A,range:B,setRange:C}),Hc={rectangles:E,strategy:Dc},Ic={dataJoin:z,expandRect:O,extent:N,fn:Ec,minimum:f,fractionalBarWidth:M,innerDimensions:L,rebind:c,rebindAll:e,scale:Gc,noSnap:G,pointSnap:H,seriesPointSnap:I,seriesPointSnapXOnly:J,seriesPointSnapYOnly:K,render:F,arrayFunctor:D,array:Cc},Jc={crosshair:W,fibonacciFan:R,container:Q,measure:P},Kc={axis:_,bar:$,candlestick:Z,ohlc:Y,errorBar:X},Lc={waterfall:aa},Mc={area:ma,bar:ka,stack:ia,line:ja},Nc={area:la,axis:qa,bar:ba,candlestick:pa,cycle:oa,line:ha,multi:T,ohlc:na,point:V,stacked:Mc,groupedBar:ga,xyBase:U,ohlcBase:fa,errorBar:ea,waterfall:ca,algorithm:Lc};ua.tickTransformer=sa;var Oc={discontinuity:{identity:ra,skipWeekends:va},dateTime:ua},Pc={bollingerBands:Ca,macd:Ba,relativeStrengthIndex:Aa,stochasticOscillator:za,forceIndex:ya,envelope:xa,elderRay:wa},Qc={bollingerBands:Wa,exponentialMovingAverage:Da,macd:Sa,percentageChange:Va,relativeStrengthIndex:Pa,stochasticOscillator:Na,slidingWindow:Fa,undefinedInputAdapter:Ja,forceIndex:La,envelope:Ia,elderRay:Ea},Rc={bollingerBands:Xa,calculator:Qc,exponentialMovingAverage:Ua,macd:Ta,merge:Ga,movingAverage:Ra,relativeStrengthIndex:Qa,stochasticOscillator:Oa,forceIndex:Ma,envelope:Ka,elderRay:Ha},Sc={algorithm:Rc,renderer:Pc},Tc={modeMedian:_a,largestTriangleThreeBucket:$a,largestTriangleOneBucket:Za,bucket:Ya},Uc={filter:{skipWeekends:db},financial:cb,walk:bb},Vc={coinbase:fb,quandl:eb},Wc={feed:Vc,random:Uc,spread:ab,sampler:Tc};/**
...
sXML="<svg xmlns='http://www.w3.org/2000/svg'>"+a+"</svg>";for(var c=b.parseFromString(sXML,"text/xml").documentElement,d=c.firstChild;d;)this.appendChild(this.ownerDocument.importNode(d,!0)),d=d.nextSibling}catch(e){throw new Error("Error parsing XML string")}}})}}((1,eval)("this").SVGElement);var Xc={cartesian:jb,sparkline:ib,tooltip:hb,smallMultiples:gb},Yc={band:lb,gridline:kb,line:S},Zc=b(function(a,b){
...
c.fillNodes(a),c.computeLayout(a)}})}),$c=Zc&&"object"==typeof Zc&&"default"in Zc?Zc["default"]:Zc;a.selection.prototype.layoutSuspended=tb,a.transition.prototype.layoutSuspended=tb,a.selection.prototype.layout=ub,a.transition.prototype.layout=ub;
// Needs to be defined like this so that the grunt task can update it
var _c="development",ad={annotation:Yc,chart:Xc,data:Wc,indicator:Sc,scale:Oc,series:Nc,svg:Kc,tool:Jc,util:Ic,version:_c,layout:Hc},bd=0,cd=!1,dd={centerOnDate:Ab,filterDataInDateRange:zb,moveToLatest:yb,trackingLatestData:xb},ed={domain:dd,layout:wb,uid:vb},fd={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},gd={base:Cb,macd:Fb,rsi:Eb,volume:Db},hd={legend:Ob,nav:Nb,primary:Mb,xAxis:Gb,secondary:gd},id={head:Xb,selectors:Tb,navigationReset:Rb,overlay:Qb},jd={toast:_b},kd={period:dc,product:cc,source:bc},ld={message:ac,messages:gc},md={legend:mc,nav:lc,navigationReset:kc,primary:jc,secondary:ic,xAxis:hc},nd={head:qc,periodAdaptor:Vb,productAdaptor:Ub,overlay:pc,dropdownConfig:oc,option:Hb,selector:nc},od={menu:nd,chart:md,data:kd,notification:ld},pd={app:Bc};pd.app().fetchCoinbaseProducts(!0).run("#app-container")});