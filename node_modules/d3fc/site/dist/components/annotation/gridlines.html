...
<html lang="en">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Gridlines
        <a class="btn btn-default" href="https://github.com/ScottLogic/d3fc/blob/master/src/annotation/gridline.js">View source</a>
      </h1>
...
<pre><code class="lang-js"><span class="hljs-built_in">var</span> xScale = d3.<span class="hljs-built_in">scale</span>.<span class="hljs-built_in">linear</span>()
    .<span class="hljs-built_in">domain</span>([<span class="hljs-number">0</span>, <span class="hljs-number">50</span>])
    .<span class="hljs-built_in">range</span>([<span class="hljs-number">0</span>, <span class="hljs-built_in">width</span>]);

<span class="hljs-built_in">var</span> yScale = d3.<span class="hljs-built_in">scale</span>.<span class="hljs-built_in">linear</span>()
    .<span class="hljs-built_in">domain</span>([<span class="hljs-number">0</span>, <span class="hljs-number">100</span>])
    .<span class="hljs-built_in">range</span>([<span class="hljs-built_in">height</span>, <span class="hljs-number">0</span>]);

<span class="hljs-built_in">var</span> gridlines = fc.annotation.gridline()
    .xScale(xScale)
    .yScale(yScale);

container.<span class="hljs-built_in">append</span>('g')
    .call(gridlines);
</code></pre>
