...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/introduction/decorate-pattern.html" />
  </head>
  <body>
    <div class="content">
...
<pre><code class="lang-js"><span class="hljs-keyword">var</span> axis = fc.svg.axis()
  .scale(ordinalScale)
  .decorate(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(s)</span> </span>{
      s.enter()
        .select(<span class="hljs-string">'text'</span>)
        .style(<span class="hljs-string">'text-anchor'</span>, <span class="hljs-string">'start'</span>)
        .attr(<span class="hljs-string">'transform'</span>, <span class="hljs-string">'rotate(45 -10 10)'</span>);
  });
</code></pre>
<style type="text/css">
.tick text {
...
<div id='decorate-axis' class='chart'></div>
...
<pre><code class="lang-js"><span class="hljs-built_in">var</span> <span class="hljs-built_in">color</span> = d3.scale.category10();
...
<span class="hljs-built_in">var</span> bar = fc.series.bar()
    ...
    .decorate(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">s</span>) </span>{
        s.enter()
          .select(<span class="hljs-string">'.bar &gt; path'</span>)
          .style(<span class="hljs-string">'fill'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d, i</span>) </span>{
              <span class="hljs-keyword">return</span> <span class="hljs-built_in">color</span>(i);
          });
    });
</code></pre>
<style type="text/css">
...
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;decorate-bars\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<div id='decorate-bars' class='chart'></div>
...
<span class="hljs-built_in">var</span> <span class="hljs-built_in">point</span> = fc.series.point()
  .xScale(xScale)
  .yScale(yScale)
  .xValue(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.date; })
  .yValue(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.close; })
  .decorate(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">s</span>) </span>{
      s.enter()
          ...
          .text(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d3.format(<span class="hljs-string">'.2f'</span>)(d.close); });
  });
</code></pre>
<div class="codepen-link">
  <form action="https://codepen.io/pen/define" method="POST" target="_blank">
    <input type="text" name="data" hidden="true"
      value='{
        "html":"&lt;div id&#x3D;\&quot;decorate-labels\&quot; class&#x3D;\&quot;chart\&quot;&gt;&lt;/div&gt;\n",
...
<div id='decorate-labels' class='chart'></div>
    ...
    .call(point);
      ...
      <nav class="visible-xs-block">
        <ul class="pager">
            ...
            <li class="next"><a href="/components/introduction/transitions.html">Transitions <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
