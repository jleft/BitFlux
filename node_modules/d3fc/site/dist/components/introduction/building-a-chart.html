...
<span class="hljs-built_in">var</span> generator = fc.data.random.walk()
...
<span class="hljs-built_in">var</span> data = generator(<span class="hljs-number">1</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d, i</span>) </span>{
    <span class="hljs-keyword">return</span> {
        <span class="hljs-attribute">month</span>: dateFormatter(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>(<span class="hljs-number">0</span>, i + <span class="hljs-number">1</span>, <span class="hljs-number">0</span>)),
        <span class="hljs-attribute">sales</span>: d + i / <span class="hljs-number">2</span>
    };
});

<span class="hljs-comment">// let's see what the data looks like</span>
d3.select(<span class="hljs-string">'#sales-data'</span>)
    .text(<span class="hljs-built_in">JSON</span>.stringify(data.slice(<span class="hljs-number">0</span>, <span class="hljs-number">3</span>), <span class="hljs-literal">null</span>, <span class="hljs-number">2</span>));
</code></pre>
...
<pre><code class="lang-js"><span class="hljs-comment">// create an svg</span>
...
<pre><code class="lang-js"><span class="hljs-keyword">var</span> chart = fc.chart.cartesian(
        d3.scale.ordinal(),
        d3.scale.linear())
...
<pre><code class="lang-js">var yExtent = fc.util.extent()
    .<span class="hljs-keyword">include</span>(<span class="hljs-number">0</span>)
    .<span class="hljs-keyword">pad</span>([<span class="hljs-number">0</span>, <span class="hljs-number">0.5</span>])
    .fields(<span class="hljs-string">'sales'</span>);

var chart = fc.chart.cartesian(
        d3.<span class="hljs-built_in">scale</span>.ordinal(),
        d3.<span class="hljs-built_in">scale</span>.linear())
    .xDomain(<span class="hljs-keyword">data</span>.map(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span></span> { <span class="hljs-keyword">return</span> d.month; }))
    .yDomain(yExtent(<span class="hljs-keyword">data</span>));
</code></pre>
...
<pre><code class="lang-js"><span class="hljs-keyword">var</span> chart = fc.chart.cartesian(
    ...
    .margin(<span class="hljs-comment">{top: 30, right: 45, bottom: 40}</span>)
    .xDomain(data.map(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> <span class="hljs-comment">{ return d.month; }</span>))
    .<span class="hljs-title">yDomain</span><span class="hljs-params">(yExtent(data)</span>)
    .<span class="hljs-title">yTicks</span><span class="hljs-params">(5)</span>
    .<span class="hljs-title">yTickFormat</span><span class="hljs-params">(valueformatter)</span>
    .<span class="hljs-title">yLabel</span><span class="hljs-params">(<span class="hljs-string">'Sales (millions)'</span>)</span>
    .<span class="hljs-title">yNice</span><span class="hljs-params">()</span>;</span>
</code></pre>
...
<pre><code class="lang-js"><span class="hljs-built_in">var</span> data = {
    <span class="hljs-comment">// target values for the annotations</span>
    <span class="hljs-attribute">targets</span>: [{
        <span class="hljs-attribute">name</span>: <span class="hljs-string">'low'</span>,
        <span class="hljs-attribute">value</span>: <span class="hljs-number">4.5</span>
    }, {
        <span class="hljs-attribute">name</span>: <span class="hljs-string">'high'</span>,
        <span class="hljs-attribute">value</span>: <span class="hljs-number">7.2</span>
    }],
    <span class="hljs-comment">// randomly generated sales data</span>
    <span class="hljs-attribute">sales</span>: generator(<span class="hljs-number">1</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d, i</span>) </span>{
        <span class="hljs-keyword">return</span> {
            <span class="hljs-attribute">month</span>: dateFormatter(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>(<span class="hljs-number">0</span>, i + <span class="hljs-number">1</span>, <span class="hljs-number">0</span>)),
            <span class="hljs-attribute">sales</span>: d + i / <span class="hljs-number">2</span>
        };
...
<span class="hljs-built_in">var</span> chart = fc.chart.cartesian(
        ...
        d3.scale.linear())
    .chartLabel(<span class="hljs-string">'2015 Cumulative Sales'</span>)
    .margin({<span class="hljs-attribute">top</span>: <span class="hljs-number">30</span>, <span class="hljs-attribute">right</span>: <span class="hljs-number">45</span>, <span class="hljs-attribute">bottom</span>: <span class="hljs-number">40</span>})
...
<span class="hljs-built_in">var</span> bar = fc.series.bar()
    .xValue(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.month; })
    .yValue(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.sales; });

<span class="hljs-built_in">var</span> annotation = fc.annotation.line()
...
<span class="hljs-built_in">var</span> multi = fc.series.multi()
    ...
    .mapping(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">series</span>) </span>{
        ...
        <span class="hljs-keyword">case</span> <span class="hljs-attribute">bar</span>:
            <span class="hljs-keyword">return</span> data.sales;
        <span class="hljs-keyword">case</span> <span class="hljs-attribute">annotation</span>:
...
<pre><code class="lang-js"><span class="hljs-keyword">var</span> bar = fc.series.bar()
    .xValue(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> </span>{ <span class="hljs-keyword">return</span> d.month; })
    .yValue(<span class="hljs-function"><span class="hljs-keyword">function</span><span class="hljs-params">(d)</span> </span>{ <span class="hljs-keyword">return</span> d.sales; })
