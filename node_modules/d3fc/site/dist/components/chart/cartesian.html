...
<html lang="en">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Cartesian
        <a class="btn btn-default" href="https://github.com/ScottLogic/d3fc/blob/master/src/chart/cartesian.js">View source</a>
      </h1>
...
<span class="hljs-built_in">var</span> data = d3.range(<span class="hljs-number">50</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{
    <span class="hljs-keyword">return</span> {
        <span class="hljs-attribute">x</span>: d / <span class="hljs-number">3</span>,
        <span class="hljs-attribute">y</span>: <span class="hljs-built_in">Math</span>.sin(d / <span class="hljs-number">3</span>)
    };
});
...
<p>A number of the more <a href="/examples/index.html">complex examples</a> use the cartesian chart as the basic &#39;boiler plate&#39; for constructing a chart.</p>
