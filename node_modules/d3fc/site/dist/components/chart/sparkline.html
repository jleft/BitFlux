...
<html lang="en">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Sparkline
        <a class="btn btn-default" href="https://github.com/ScottLogic/d3fc/blob/master/src/chart/sparkline.js">View source</a>
      </h1>
...
<pre><code class="lang-js">d3.selectAll(<span class="hljs-string">'.sparkline'</span>)
    .each(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
        <span class="hljs-built_in">var</span> sparkline = d3.select(<span class="hljs-keyword">this</span>);
        ...
        <span class="hljs-built_in">var</span> data = fc.data.random.financial()(<span class="hljs-number">50</span>);

        <span class="hljs-built_in">var</span> chart = fc.chart.sparkline()
        ...
        sparkline
            ...
            .style({
                <span class="hljs-attribute">height</span>: <span class="hljs-string">'15px'</span>,
                <span class="hljs-attribute">width</span>: <span class="hljs-string">'80px'</span>,
                <span class="hljs-attribute">display</span>: <span class="hljs-string">'inline'</span>
            })
            .datum(data)
            .call(chart);
    });
