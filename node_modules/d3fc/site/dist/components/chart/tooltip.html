...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://d3fc.io/components/chart/tooltip.html" />
  </head>
  <body>
    <div class="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Tooltip
        <a class="btn btn-default" href="https://github.com/ScottLogic/d3fc/blob/master/src/chart/tooltip.js">View source</a>
      </h1>
      <p>The tooltip component renders the bound data as a table, where the mapping from the data to the tabular form is expressed via the <code>items</code> property as demonstrated below:</p>
<pre><code class="lang-js"><span class="hljs-built_in">var</span> data = {
  <span class="hljs-attribute">high</span>: <span class="hljs-number">34.5</span>,
  <span class="hljs-attribute">low</span>: <span class="hljs-number">32.53</span>,
  <span class="hljs-attribute">open</span>: <span class="hljs-number">33.7</span>,
  <span class="hljs-attribute">close</span>: <span class="hljs-number">33.6</span>
};

<span class="hljs-built_in">var</span> priceFormat = d3.format(<span class="hljs-string">'.2f'</span>);
<span class="hljs-built_in">var</span> tooltip = fc.chart.tooltip()
    .items([
        [<span class="hljs-string">'open'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> priceFormat(d.open); }],
        [<span class="hljs-string">'high'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> priceFormat(d.high); }],
        [<span class="hljs-string">'low'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> priceFormat(d.low); }],
        [<span class="hljs-string">'close'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> priceFormat(d.close); }]
    ]);

<span class="hljs-built_in">var</span> svg = d3.select(<span class="hljs-string">'#tooltip'</span>)
  .attr({<span class="hljs-attribute">width</span>: <span class="hljs-number">100</span>, <span class="hljs-attribute">height</span>: <span class="hljs-number">60</span>});

svg.datum(data)
  .call(tooltip);
</code></pre>
<p>Which results in the following:</p>
<p><svg id="tooltip"> </svg></p>
...
<p>Both the label and value for each row can be expressed as a constant or a function of the bound data.</p>
<p>The tooltip uses <a href="/components/layout/flexbox.html">flexbox layout</a> in order to construct the rows / columns. As a result, the size of the tooltip is determined by the size of its containing element, which is determined either by measuring the element dimensions, or from the <code>layout-width</code> and <code>layout-height</code> properties as described in the flexbox layout documentation.</p>
<p>The tooltip is most often used in conjunction with the crosshair component, consult the <a href="/components/tool/crosshair.html">crosshair documentation</a> for more details.</p>


      <nav class="visible-xs-block">
        <ul class="pager">
            <li class="previous"><a href="/components/chart/sparkline.html"><span aria-hidden="true">&larr;</span> Sparkline</a></li>
            <li class="next"><a href="/components/series/area.html">Area Series <span aria-hidden="true">&rarr;</span></a></li>
        </ul>
      </nav>
    </div>
