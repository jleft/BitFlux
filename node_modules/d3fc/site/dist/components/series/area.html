...
<html lang="en">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Area Series
        <a class="btn btn-default" href="https://github.com/ScottLogic/d3fc/blob/master/src/series/area.js">View source</a>
      </h1>
...
<span class="hljs-built_in">var</span> data = dataGenerator(<span class="hljs-number">100</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">datum, index</span>) </span>{
    <span class="hljs-keyword">return</span> {
        <span class="hljs-attribute">x</span>: index,
        <span class="hljs-attribute">y0</span>: datum,
        <span class="hljs-attribute">y1</span>: datum + <span class="hljs-built_in">Math</span>.random() * <span class="hljs-number">10</span>
    };
});
...
<span class="hljs-built_in">var</span> yScale = d3.scale.linear()
    .domain(fc.util.extent().fields([<span class="hljs-string">'y0'</span>, <span class="hljs-string">'y1'</span>])(data))
    .range([height, <span class="hljs-number">0</span>]);

<span class="hljs-built_in">var</span> area = fc.series.area()
    .xValue(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.x; })
