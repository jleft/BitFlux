...
<html lang="en">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-xs-12">
      <h1>
        Bar Series
        <a class="btn btn-default" href="https://github.com/ScottLogic/d3fc/blob/master/src/series/bar.js">View source</a>
      </h1>
...
<p>This series has the same <code>xValue</code>, <code>yValue</code> and <code>decorate</code> properties as the <a href="/components/series/point.html">point series</a>. You can also specify the width of the bars via the <code>barWidth</code> property.</p>
<p>The bar series supports horizonal display, using the <code>orient</code> property.</p>
<pre><code class="lang-js"><span class="hljs-built_in">var</span> dataGenerator = fc.data.random.walk();
<span class="hljs-built_in">var</span> data = dataGenerator(<span class="hljs-number">20</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">datum, index</span>) </span>{
    <span class="hljs-keyword">return</span> {
        <span class="hljs-comment">// notice that x &amp; y have been transposed!</span>
        <span class="hljs-attribute">x</span>: datum,
        <span class="hljs-attribute">y</span>: index
    };
});

<span class="hljs-built_in">var</span> xScale = d3.scale.linear()
    .domain(fc.util.extent().fields(<span class="hljs-string">'x'</span>)(data))
    .range([<span class="hljs-number">0</span>, width]);

<span class="hljs-built_in">var</span> yScale = d3.scale.linear()
    .domain(fc.util.extent().fields(<span class="hljs-string">'y'</span>)(data))
