...
<span class="hljs-built_in">var</span> stream = fc.data.random.financial().stream();
<span class="hljs-built_in">var</span> data = stream.take(<span class="hljs-number">110</span>);
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">renderChart</span>(<span class="hljs-params"></span>) </span>{
    ...
    <span class="hljs-built_in">var</span> bollingerAlgorithm = fc.indicator.algorithm.bollingerBands();
    bollingerAlgorithm(data);

    <span class="hljs-comment">// Offset the range to include the full bar for the latest value</span>
    <span class="hljs-built_in">var</span> DAY_MS = <span class="hljs-number">1000</span> * <span class="hljs-number">60</span> * <span class="hljs-number">60</span> * <span class="hljs-number">24</span>;
    <span class="hljs-built_in">var</span> xExtent = fc.util.extent()
    ...
    <span class="hljs-built_in">var</span> yExtent = fc.util.extent().fields([
    ...
    <span class="hljs-built_in">var</span> chart = fc.chart.cartesian(
     ...
     .margin({<span class="hljs-attribute">left</span>: <span class="hljs-number">30</span>, <span class="hljs-attribute">right</span>: <span class="hljs-number">30</span>, <span class="hljs-attribute">bottom</span>: <span class="hljs-number">20</span>, <span class="hljs-attribute">top</span>: <span class="hljs-number">30</span>});

    <span class="hljs-comment">// obtain ticks from the underlying scales</span>
    <span class="hljs-built_in">var</span> xTicks = chart.xScaleTicks(<span class="hljs-number">10</span>);
    <span class="hljs-built_in">var</span> yTicks = chart.yScaleTicks(<span class="hljs-number">10</span>);
    ...
    <span class="hljs-built_in">var</span> gridlines = fc.annotation.gridline()
        .xTickValues(xTicks)
        .yTickValues(yTicks);
    <span class="hljs-built_in">var</span> candlestick = fc.series.candlestick();
    <span class="hljs-built_in">var</span> bollingerBands = fc.indicator.renderer.bollingerBands();
...
renderChart();
<span class="hljs-built_in">var</span> intervalId = setInterval(renderChart, <span class="hljs-number">200</span>);
</code></pre>
