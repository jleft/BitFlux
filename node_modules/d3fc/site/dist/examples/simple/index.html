...
<span class="hljs-built_in">var</span> data = d3.range(<span class="hljs-number">50</span>).map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{
    <span class="hljs-keyword">return</span> {
        <span class="hljs-attribute">x</span>: d / <span class="hljs-number">4</span>,
        <span class="hljs-attribute">y</span>: <span class="hljs-built_in">Math</span>.sin(d / <span class="hljs-number">4</span>),
        <span class="hljs-attribute">z</span>: <span class="hljs-built_in">Math</span>.cos(d / <span class="hljs-number">4</span>) * <span class="hljs-number">0.7</span>
    };
});
...
<span class="hljs-built_in">var</span> chart = fc.chart.cartesian(
          ...
          .margin({<span class="hljs-attribute">left</span>: <span class="hljs-number">50</span>, <span class="hljs-attribute">bottom</span>: <span class="hljs-number">20</span>, <span class="hljs-attribute">top</span>: <span class="hljs-number">30</span>});

<span class="hljs-comment">// create a pair of series and some gridlines</span>
<span class="hljs-built_in">var</span> sinLine = fc.series.line()
...
<span class="hljs-built_in">var</span> cosLine = fc.series.area()
  .xValue(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">d</span>) </span>{ <span class="hljs-keyword">return</span> d.x; })
