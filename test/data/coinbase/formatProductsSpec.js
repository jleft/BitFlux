...
var hr1 = 3600;
var day1 = 86400;
var defaults = [hr1, day1];
var exceptions = d3.map();
exceptions.set('BTC-USD', [min1, min5, hr1, day1]);
...
describe('data/coinbase/formatProducts', function() {
    it('should assign the correct periods to BTC-USD', function() {
        ...
        var productResponse = formatProducts(btcusd, null, defaults, exceptions);
    ...
    it('should assign the correct periods to BTC-GBP', function() {
        ...
        var productResponse = formatProducts(btcgbp, null, defaults, exceptions);
    ...
    it('should assign the correct periods to BTC-EUR', function() {
        ...
        var productResponse = formatProducts(btceur, null, defaults, exceptions);
        expect(productResponse[0].periods.length).toEqual(2);
        expect(productResponse[0].periods[0]).toEqual(hr1);
        expect(productResponse[0].periods[1]).toEqual(day1);
    });
    ...
    it('should assign the correct periods to BTC-CAD', function() {
        ...
        var productResponse = formatProducts(btccad, null, defaults, exceptions);
        expect(productResponse[0].periods.length).toEqual(2);
        expect(productResponse[0].periods[0]).toEqual(hr1);
        expect(productResponse[0].periods[1]).toEqual(day1);
    });
